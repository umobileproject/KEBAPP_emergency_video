...
package uk.ac.ucl.umobile.utils;
...
import uk.ac.ucl.kbapp.net.wifi.WifiDirectServiceDiscovery;
...
public class G {
  ...
  private static final List<String> wifiTags = new ArrayList<>(Arrays.asList("ContentAdvertisement","WifiLink", "WifiDirectHotSpot","WifiDirectServiceDiscovery",WifiDirectServiceDiscovery.class.getName(),WifiLink.class.getName()));
